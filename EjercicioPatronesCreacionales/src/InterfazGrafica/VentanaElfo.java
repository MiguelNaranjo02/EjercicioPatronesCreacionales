...
public class VentanaElfo extends JFrame {

	private JPanel contentPane;
	private FabricaElfos fabrica;
	...
	public VentanaElfo() {
		...
		lblnomArmadura.setBounds(103, 158, 101, 35);
		...
		tArDesArmadura.setBounds(75, 346, 160, 127);
		...
		lblnomArma.setBounds(280, 158, 90, 35);
		contentPane.add(lblnomArma);
		
		JLabel lblsrcArco = new JLabel("");
		lblsrcArco.setBounds(259, 225, 130, 97);
		contentPane.add(lblsrcArco);
		Image Arco= new ImageIcon(arma.getSrcArmas()).getImage();
		ImageIcon nArco=new ImageIcon(Arco.getScaledInstance(130, 97, Image.SCALE_SMOOTH));
		lblsrcArco.setIcon(nArco);
		...
		tArDesArco.setBounds(245, 346, 160, 127);
		...
		lblnomMontura.setBounds(0, 0, 50, 35);
		...
		tArDescripcion.setBounds(592, 158, 160, 351);
		...
		lblNewLabel.setBounds(95, 265, 109, 97);
